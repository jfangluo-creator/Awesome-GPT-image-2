...
个人精选的 GPT image 2 图像生成案例收藏，收集有趣的 prompt 与生成效果。

> 遇到好看的生成图就收藏下来，方便以后参考。以后也会收集视频相关的 prompt。
...
[案例 1-100](docs/cases/cases-001-100.md) · [案例 101-200](docs/cases/cases-101-200.md) · [案例 201-300](docs/cases/cases-201-300.md) · [案例 301-400](docs/cases/cases-301-400.md) · [案例 401-500](docs/cases/cases-401-500.md) · [案例 501-600](docs/cases/cases-501-600.md) · [案例 601-700](docs/cases/cases-601-700.md) · [案例 701-800](docs/cases/cases-701-800.md) · [案例 801-900](docs/cases/cases-801-900.md) · [案例 901-1000](docs/cases/cases-901-1000.md) · [案例 1001-1100](docs/cases/cases-1001-1100.md)
...
- **全链路闭环** — 从文本/脚本到成片一站式完成，告别多工具间反复导入导出
- **短剧生产 6 步流水线** — 剧情解析 → 角色资产 → 分镜 → 配音对齐 → 合成发布
- **角色一致性** — 角色设定跨场景复用，外观气质稳定不跳戏
- **多角色配音同步** — 声线管理 + 台词与镜头节奏自动贴合
- **工业化产出** — 批量生成、版本管理、快速二次迭代

## 关于

这是一个个人兴趣项目，收集自己喜欢和觉得有趣的 AI 生成图片案例。

- 案例来源：Twitter/X、小红书、即刻、Reddit 等社区分享，以及自己用 GPT image 2 生成的作品
- 每个案例尽量标注原作者，如有侵权请联系删除
- 如果你也觉得有趣，欢迎 Star
